Gem::Specification.new do |s|
  ...
  s.email = "git@github.com"
  s.homepage = "http://github.com/Artforge/rvideo/"
  s.description = "Gives you video"
  s.has_rdoc = false
  s.authors = ["Adam Singer", "Zencoder"]
  s.require_paths = ["lib", "License.txt", "rvideo.gemspec", "RULES", "README.txt", "TODO.txt", "lib/rvideo.rb", "lib/rvideo/", "lib/rvideo/errors.rb", "lib/rvideo/float.rb", "lib/rvideo/inspector.rb", "lib/rvideo/transcoder.rb", "lib/rvideo/version.rb", "lib/rvideo/tools/abstract_tool.rb", "lib/rvideo/tools/ffmpeg.rb", "lib/rvideo/tools/ffmpeg2theora.rb", "lib/rvideo/tools/flvtool2.rb", "lib/rvideo/tools/mencoder.rb", "lib/rvideo/tools/mp4box.rb", "lib/rvideo/tools/mp4creator.rb", "lib/rvideo/tools/mplayer.rb", "lib/rvideo/tools/yamdi.rb"]
end